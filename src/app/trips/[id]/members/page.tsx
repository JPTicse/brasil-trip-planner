  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">Miembros</h2>
      ...
      {isOwner && (
        <div className="mt-8 rounded-xl border border-red-200 bg-red-50/50 p-4 dark:border-red-800/50 dark:bg-red-900/20">
...
function AccessRequestCard({
  ...
  return (
    <div className="rounded-xl border border-amber-200 bg-amber-50/50 p-3 shadow-sm dark:border-amber-700/50 dark:bg-amber-900/20">
      ...
      <div className="mt-3 flex gap-2">
        ...
        <form action={resolveAccessRequest} className="flex-1">
          ...
          <button
            type="submit"
            className="w-full rounded-lg border border-red-300 bg-white px-3 py-1.5 text-xs font-semibold text-red-600 transition hover:bg-red-50 dark:border-red-700 dark:bg-zinc-900 dark:text-red-400 dark:hover:bg-red-900/20"
          >
            Rechazar
          </button>
        </form>
...
function MemberCard({
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border border-zinc-200 bg-white p-3 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100">
            {name}
            {isCurrentUser && (
              <span className="ml-1.5 text-xs text-zinc-400 dark:text-zinc-500">(tú)</span>
            )}
          </p>
